...
const CallingModal = () => {
    ...
    const [showCallDetail, setShowCallDetail] = useState(true)
    return (
        <div className='floating-modal-wrapper' style={{ position: 'absolute', top: '50px', left: '50px' }}>
            <div className="floating-modal">
                <div className="basic-info">
                    ...
                    <div className="content">
                        <div className="content-main">
                            <div className="hide-btn" onClick={() => { setShowCallDetail(!showCallDetail) }}>
                ...
                {showCallDetail ?
                    <div className='call-detail' style={{ display: 'flex', padding: '12px 16px', flexDirection: 'column', alignItems: 'center', gap: '12px', alignSelf: 'stretch', backgroundColor: '#F5F6FA' }}>
                        <BasicSwitch switchStatus={false} switchText={'Gửi khảo sát'} />
                    </div>
                    : ''}
            </div>
        </div>
